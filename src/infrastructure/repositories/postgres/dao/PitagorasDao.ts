            ...
            return await this.dbCm.tx(async (t1) => {
                ...
                try {
                    ...
                    const result = await t1.one<{ id: number }>(
                        `INSERT INTO public.dineros_recibidorSS (fecha, terminal, equipo, recibidor, forma_de_pago, numero_aprobacion, valor, usuario, entrega,prefijo,factura,banco,cheque,cuenta_cheque,cuenta_cartera)
