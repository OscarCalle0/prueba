...
import { CLOUD_CONNECTION_PARAMETERS, CM_CONNECTION_PARAMETERS, CLOUD_CONNECTION_PARAMETERS_REPLICA } from './Config';
...
const getReplicaConexion = (db: string): IConnectionParameters => {
    const DATABASES: IEnvironments<IConnectionParameters> = {
        development: {},
        testing: {},
        production: {},
...
export const replicaDB = pgp(getReplicaConexion('public')) as IDatabase<IMain>;
